...
// callbacks type
SPDLOG_EXPORT typedef std::function<void(const details::log_msg &msg)> custom_log_callback;
...
SPDLOG_EXPORT using callback_sink_mt = callback_sink<std::mutex>;
SPDLOG_EXPORT using callback_sink_st = callback_sink<details::null_mutex>;
