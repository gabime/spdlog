...
void basic_example()
{
    ...
    auto my_logger = spdlog::basic_logger_mt("file_logger", "logs/basic-log.txt", false, file_event_handlers);
}
...
void daily_example()
{
    ...
    auto daily_logger = spdlog::daily_logger_mt("daily_logger", "logs/daily.txt", 2, 30, false, 0, file_event_handlers);
}
...
void async_example()
{
    ...
    auto async_file = spdlog::basic_logger_mt<spdlog::async_factory>("async_file_logger", "logs/async_log.txt", false, file_event_handlers);
    // alternatively:
...
void multi_sink_example()
{
    ...
    auto file_sink = std::make_shared<spdlog::sinks::basic_file_sink_mt>("logs/multisink.txt", true, file_event_handlers);
