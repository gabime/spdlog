...
//   1. the fmt::formatter specializations defined in the global module fragment
//      survive (stopwatch, to_hex),
...
TEST_CASE("module: stopwatch formatter survives the global module fragment", "[module]") {
    spdlog::stopwatch sw;
...
TEST_CASE("module: to_hex formatter survives the global module fragment", "[module]") {
...
TEST_CASE("module: async factory", "[module]") {
    // references details::default_async_q_size from the global module fragment
