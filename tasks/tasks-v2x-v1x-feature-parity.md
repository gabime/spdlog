...
- **Latest pass:** `24dde318` **`rotate_now`** mutex lock (#3281); **SUPERSEDED** `a2b42620` (CMake min), `f355b3d5` (daily test), triage row **`d276069a`**. Prior: `1245bf8e` README. See [`merge-report-v2x-v1x.md`](merge-report-v2x-v1x.md).
- **Triage snapshot:** **38 PORTED**, **44 SUPERSEDED**, **118 N/A**, **45 PENDING** — [`v1-triage-complete.md`](v1-triage-complete.md).
...
- [ ] 5.0 Documentation, merge report, and release readiness (4B)
  - [ ] 5.1 Complete **3A** triage: every v1.x commit in range has status **ported**, **superseded**, or **N/A** with reason (no silent gaps). *(Partial: [`v1-triage-complete.md`](v1-triage-complete.md) lists all 245 SHAs; **38** ported, **44** superseded, **118** N/A, **45** **PENDING** — reclassify PENDING over time.)*
