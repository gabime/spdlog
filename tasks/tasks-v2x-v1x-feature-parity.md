...
- **Latest pass:** Triage sync (`ad725d34` **getenv**, `677a2d93` stopwatch timing, utf8/syslog/stopwatch **SUPERSEDED**); `3f7e5028` **utf8** assert sign-compare; `a6215527` **ringbuffer** `n_items==0` throws; `287333ee` color **`final`** **SUPERSEDED** (v2 sink headers differ). Commits pushed on **`integration/v2-sync-v1`** as work lands. See [`merge-report-v2x-v1x.md`](merge-report-v2x-v1x.md).
- **Triage snapshot:** **27 PORTED**, **26 SUPERSEDED**, **114 N/A**, **78 PENDING** — [`v1-triage-complete.md`](v1-triage-complete.md).
...
- [ ] 5.0 Documentation, merge report, and release readiness (4B)
  - [ ] 5.1 Complete **3A** triage: every v1.x commit in range has status **ported**, **superseded**, or **N/A** with reason (no silent gaps). *(Partial: [`v1-triage-complete.md`](v1-triage-complete.md) lists all 245 SHAs; **27** ported, **26** superseded, **114** N/A, **78** **PENDING** — reclassify PENDING over time.)*
